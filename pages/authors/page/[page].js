...
import authorsPageInitialPaths1eebeResource from '../../../resources/authors-page-initial-paths-1eebe'
import authorsPageInitialProps5fbddResource from '../../../resources/authors-page-initial-props-5fbdd'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPaths1eebeResource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialProps5fbddResource({
    ...context?.params,
